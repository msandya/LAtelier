<template>
    <div>
        <div class="text-center" style="padding: 50px">
            ...
            <button type="button" @click="login('Facebook')" class="btn btn-lg btn-block btn-primary"><i class="fa fa-github" aria-hidden="true"></i> Se connecter via Facebook</button>
