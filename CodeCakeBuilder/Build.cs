        ...
        public Build()
        {
            ...
            Task( "Unit-Testing" )
                ...
                .Does( () =>
                {
					...
					if( !( testNetFrameworkDlls == null || testNetFrameworkDlls.size == 0))
					{
                ...
                .Does( () =>
                 {
                     ...
                     {
                         // All Version
                         PushNuGetPackages( "MYGET_PREVIEW_API_KEY", "https://www.myget.org/F/kdo-preview/api/v2/package", nugetPackages );
                     }
                     else
                     {
                         Debug.Assert( gitInfo.IsValidCIBuild );
                         PushNuGetPackages( "MYGET_CI_API_KEY", "https://www.myget.org/F/kdo-ci/api/v2/package", nugetPackages );
                     }
